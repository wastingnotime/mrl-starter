...
If a locally observed issue belongs to another repository, use `docs/operating/cross_repo_findings_guidance.md` and record the evidence under `work/findings/` instead of turning it into a hidden cross-repo fix.
